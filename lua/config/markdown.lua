...
vim.api.nvim_create_autocmd("FileType", {
  ...
  callback = function(ev)
    ...
    -- Follow link under cursor: follow-md-links maps <CR> already.
    -- To jump back, use the built-in <C-^> (alternate file) -- <BS> is left
    -- alone so it keeps its normal "move left" behaviour.

    -- Telescope: jump to headings in current buffer.
    -- No community convention exists for this; g-prefix reads as "goto", and
    -- vanilla `gh` (start Select mode) is effectively unused.
